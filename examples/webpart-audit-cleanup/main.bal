...
public function main() returns error? {
    ...
    pages:WebPartCollectionResponse webPartsResponse = check sharepointClient->pagesAsSitePageListWebParts(siteId, pageId);
    ...
    pages:WebPartPositionResponse webPartPosition = check sharepointClient->pagesAsSitePageWebPartsGetPositionOfWebPart(siteId, pageId, webPartId);
    ...
    check sharepointClient->pagesAsSitePageDeleteWebParts(siteId, pageId, webPartId);
