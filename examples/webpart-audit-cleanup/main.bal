...
public function main() returns error? {
    ...
    pages:WebPartCollectionResponse webPartsResponse = check sharepointClient->listSitePageWebParts(siteId, pageId);
    ...
    pages:WebPartPositionResponse webPartPosition = check sharepointClient->getSitePageWebPartPosition(siteId, pageId, webPartId);
    ...
    check sharepointClient->deleteSitePageWebPart(siteId, pageId, webPartId);
